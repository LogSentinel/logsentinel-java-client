...
public class HashApiTest {
    ...
    public void getHashableContentTest() throws ApiException {
        ...
        String response = api.getHashableContent(applicationId, action, actorId, auditLogEntryType, signature, actorDepartment, actorDisplayName, actorRoles, details, logLevel, null, null);
    ...
    public void getHashableContentForAuthActionTest() throws ApiException {
        ...
        List<String> actorRoles = null;
        String details = null;
        String response = api.getHashableContentForAuthAction(applicationId, actorId, authAction, signature, signedLoginChallenge, userPublicKey, actorDepartment, actorDisplayName, actorRoles, details, null, null);
    ...
    public void getHashableContentForStandardActionTest() throws ApiException {
        ...
        String details = null;
        String logLevel = null;
        String response = api.getHashableContentForStandardAction(applicationId, action, actorId, entityId, entityType, auditLogEntryType, signature, actorDepartment, actorDisplayName, actorRoles, details, logLevel, null, null);
    ...
    public void getHashableContentSimpleTest() throws ApiException {
        ...
        String details = null;
        String logLevel = null;
        String response = api.getHashableContentSimple(applicationId, auditLogEntryType, signature, details, logLevel, null, null);
