...
public class SearchApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public List<AuditLogEntry> search(SearchRequest searchRequest) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<AuditLogEntry>> searchWithHttpInfo(SearchRequest searchRequest) throws ApiException {
   ...
   * @param applicationIds applicationIds (optional)
   * @return List&lt;AuditLogEntry&gt;
   * @throws ApiException if fails to make API call
   */
  public List<AuditLogEntry> searchByParam(String applicationId, Long endTime, Integer page, Integer pageSize, String query, Long startTime, List<UUID> applicationIds) throws ApiException {
    return searchByParamWithHttpInfo(applicationId, endTime, page, pageSize, query, startTime, applicationIds).getData();
      }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<List<AuditLogEntry>> searchByParamWithHttpInfo(String applicationId, Long endTime, Integer page, Integer pageSize, String query, Long startTime, List<UUID> applicationIds) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'applicationId' is set
    if (applicationId == null) {
      throw new ApiException(400, "Missing the required parameter 'applicationId' when calling searchByParam");
    }
    
    // verify the required parameter 'endTime' is set
    if (endTime == null) {
      throw new ApiException(400, "Missing the required parameter 'endTime' when calling searchByParam");
    }
    
    // verify the required parameter 'page' is set
    if (page == null) {
      throw new ApiException(400, "Missing the required parameter 'page' when calling searchByParam");
    }
    
    // verify the required parameter 'pageSize' is set
    if (pageSize == null) {
      throw new ApiException(400, "Missing the required parameter 'pageSize' when calling searchByParam");
    }
    
    // verify the required parameter 'query' is set
    if (query == null) {
      throw new ApiException(400, "Missing the required parameter 'query' when calling searchByParam");
    }
    
    // verify the required parameter 'startTime' is set
    if (startTime == null) {
      throw new ApiException(400, "Missing the required parameter 'startTime' when calling searchByParam");
    }
    ...
    localVarQueryParams.addAll(apiClient.parameterToPairs("multi", "applicationIds", applicationIds));
